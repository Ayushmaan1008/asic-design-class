...
`include "sp_verilog.vh" //_\SV
   ...
   wire clk_ayushmaan = clk;
   
`include "RiscV_CPU_gen.v" //_\TLV
   ...
   //_|cpu
      //_@0
         ...
         assign CPU_clk_ayushmaan_a0 = clk_ayushmaan;
      ...
      //       other than those specifically expected in the labs. You'll get strange errors for these.
         ...
         `BOGUS_USE(CPU_is_beq_a5 CPU_is_bne_a5 CPU_is_blt_a5 CPU_is_bge_a5 CPU_is_bltu_a5 CPU_is_bgeu_a5 CPU_clk_ayushmaan_a5)
         `BOGUS_USE(CPU_is_sb_a5 CPU_is_sh_a5 CPU_is_sw_a5)
   // Assert these to end simulation (before Makerchip cycle limit).
   /*SV_plus*/
      always @ (posedge clk_ayushmaan) begin
   ...
   //  o CPU visualization
   //_|cpu
      //_\source /raw.githubusercontent.com/shivanishah269/riscvcore/master/FPGAImplementation/riscvshelllib.tlv 16   // Instantiated from RiscV_CPU.tlv, 273 as: m4+imem(@1)
      ...
      //_\source /raw.githubusercontent.com/shivanishah269/riscvcore/master/FPGAImplementation/riscvshelllib.tlv 31   // Instantiated from RiscV_CPU.tlv, 274 as: m4+rf(@2, @3)
         // Reg File
         //_@3
      ...
      //_\source /raw.githubusercontent.com/shivanishah269/riscvcore/master/FPGAImplementation/riscvshelllib.tlv 48   // Instantiated from RiscV_CPU.tlv, 275 as: m4+dmem(@4)
         // Data Memory
         //_@4
...
// Undefine macros defined by SandPiper (in "RiscV_CPU_gen.v").
`undef BOGUS_USE
