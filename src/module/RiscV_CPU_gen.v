...
// For |cpu$clk_ayushmaan.
wire CPU_clk_ayushmaan_a0;
reg  CPU_clk_ayushmaan_a1,
     CPU_clk_ayushmaan_a2,
     CPU_clk_ayushmaan_a3,
     CPU_clk_ayushmaan_a4,
     CPU_clk_ayushmaan_a5;
...
wire clkP_CPU_rs2_valid_a2 ;
   ...
   //
      ...
      // Staging of $clk_ayushmaan.
      always @(posedge clk) CPU_clk_ayushmaan_a1 <= CPU_clk_ayushmaan_a0;
      always @(posedge clk) CPU_clk_ayushmaan_a2 <= CPU_clk_ayushmaan_a1;
      always @(posedge clk) CPU_clk_ayushmaan_a3 <= CPU_clk_ayushmaan_a2;
      always @(posedge clk) CPU_clk_ayushmaan_a4 <= CPU_clk_ayushmaan_a3;
      always @(posedge clk) CPU_clk_ayushmaan_a5 <= CPU_clk_ayushmaan_a4;
